...
@MessageDriven(activationConfig = {
		...
		@ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "Type = 'java:/jms/topic/Topic06'"), })
public class FilteredConsumer06 implements MessageListener {
	@EJB
