...
@MessageDriven(activationConfig = {
		...
		@ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "Type = 'java:/jms/topic/Topic08'"), })
public class FilteredConsumer08 implements MessageListener {
	@EJB
