...
@MessageDriven(activationConfig = {
		...
		@ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "Type = 'java:/jms/topic/Topic07'"), })
public class FilteredConsumer07 implements MessageListener {
	@EJB
