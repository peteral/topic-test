...
@MessageDriven(activationConfig = {
		...
		@ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "Type = 'java:/jms/topic/Topic09'"), })
public class FilteredConsumer09 implements MessageListener {
	@EJB
