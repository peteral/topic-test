...
@MessageDriven(activationConfig = {
		...
		@ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "Type = 'java:/jms/topic/Topic02'"), })
public class FilteredConsumer02 implements MessageListener {
	@EJB
